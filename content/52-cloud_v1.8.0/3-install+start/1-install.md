...
Чтобы установить eVision Cloud и добавить на главный экран вашего мобильного устройства, необходимо выполнить следующие шаги:

1. Запускаем браузер на мобильном устройстве:
...
Последние четыре цифры номера звонящего являются кодом доступа для вашей авторизации на сервисе eVision Cloud (в нашем случае 8103):
...
10.  Нажимаем на кнопку **Установить** и дожидаемся окончания установки:
