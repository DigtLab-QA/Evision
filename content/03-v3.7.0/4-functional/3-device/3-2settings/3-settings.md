...
### Лицензия
Раздел **Лицензия** необходим для ввода лицензионного ключа. Лицензионный ключ прописывается для каждого устройства. По-умолчанию в **eVision** на одно устройство доступна встроенная лицензия. Встроенная лицензия закрепляется на первом устройстве, добавленном в **eVision**. Срок действия встроенной лицензии для версии на Ubuntu - 14 дней с момента активации видеоаналитики на устройстве, для версии на Windows - 365 дней с момента активации.
...
Почтовые уведомления предназначены для отправки данных из отчета Рабочее время на адрес электронной почты.

![](images/Screenshot_161.png)

Кнопка **Активация** - для включения сервиса **Почтовые уведомления**

Кнопка **Настройка почтового сервиса** - для ввода параметров отправки отчета по рабочему времени

Поле **Кому** - для ввода адреса электронной почты, на которую следует отправлять почтовые уведомления

Пункт **Тип отчета** - для выбора запроса **Отчет по рабочему времени**

Блок **Текст при отправке сообщения** - поле для ввода в письме названия отчета по рабочему времени, отправляемого получателю

Поле **Время работы** - поле для ввода периода рабочего времени

Поле **Отправлять письмо в** - поле для ввода времени, в которое необходимо  отправлять отчет по рабочему времени

Пункт **Отправлять при условии** - список для выбора подходящего условия отправки: **Всегда, Время меньше установленного, Время отличается от установленного**
...
**Порог трекинга** - позволяет выбрать минимальный порог для трекинга персоны. Изменяется от 0.1 до 1. По умолчанию выбрано значение - 0.2.
...
В блоке **Распознавание автомобильных номеров** доступны следующие настройки:

- позволяет включить или отключить режим распознавания автомобильных номеров.
  
Кнопка включения ![](images/Screenshot_163.png) - позволяет включить или отключить режим распознавания автомобильных номеров.
