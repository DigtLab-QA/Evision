...
**!** Если в данном списке нет устройства, которое используется у вас, то в списке **Устройство** выберите пункт **многоточие**, он находится в конце списка![](images/Screenshot_14.png)
...
Выберите модель устройства из выпадающего списка, если данное устройство присутствует в списке. 
**!** Если вашего устройства в списке нет, выберите пункт **многоточие**, он находится в конце списка![](images/Screenshot_14.png)
...
**!** При удалении устройства распознанные лица с него в истории  сохраняются.
